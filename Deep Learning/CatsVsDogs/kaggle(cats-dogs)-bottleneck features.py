# -*- coding: utf-8 -*-
"""
Created on Sat Oct  6 14:13:41 2018
...
def save_bottleneck_features(model, preprocess_fn, train_dir, validation_dir, test_dir, bottleneck_dir):
...
bottleneck_dir = 'C:\\Data Science\\Deep Learning\\data\Dogs Vs Cats Redux\\bottleneck_features'
preprocess = applications.vgg16.preprocess_input
save_bottleneck_features(model, preprocess, train_dir, validation_dir, test_dir, bottleneck_dir)
os.getcwd()
os.chdir('C:\\Data Science\\Deep Learning\\data\\Dogs Vs Cats Redux\\bottleneck_features')
