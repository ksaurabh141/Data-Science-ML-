# -*- coding: utf-8 -*-
"""
Created on Sat Aug 18 10:32:01 2018
...
Ordinal_features1 = ['BsmtQual','BsmtCond','FireplaceQu','PoolQC','ExterQual','ExterCond','HeatingQC','KitchenQual','GarageQual','GarageCond']
quality_dict = {'NA':0, 'Po':1, 'Fa':2, 'TA':3, 'Gd':4, 'Ex':5 }
for feature in Ordinal_features1:
    null_idx = house_data[feature].isnull()
    house_data.loc[null_idx,feature] = 'NA'
